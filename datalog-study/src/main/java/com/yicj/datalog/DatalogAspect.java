...
import com.yicj.domain.ActionType;
import com.yicj.domain.ChangeItem;
import com.yicj.util.DiffUtil;
...
public class DatalogAspect {
    ...
    @Pointcut("execution(public * com.yicj.dao.*.save*(..))")
    public void save(){

    }

    @Pointcut("execution(public * com.yicj.dao.*.delete*(..))")
    public void delete(){

...
public class ExecutionAspectConfig {
 ...
 @Pointcut("execution(public String com.yicj.service..*Service.*(..))")
 public void matchCondition1(){}

 @Pointcut("execution(public * com.yicj.service..*Service.*(..) throws java.lang.IllegalAccessException)")
 public void matchCondition2(){}

 @Before("matchCondition1()")
 public void before(){
  System.out.println("");
